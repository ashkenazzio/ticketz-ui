/**
 * Static version of OrderDetail for design system showcase.
...
export default function StaticOrderDetail() {
  const { db, currentUser } = useData();

  // Get first order for current user from database
  const orderData = useMemo(() => {
    if (!currentUser) return null;
    const orders = db.orders.getByUser(currentUser.id);
    ...
    return (
      <div className="pt-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 text-center">
          ...
          <p className="text-gray-400 mb-4">No orders available in sample data.</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="bg-surface border border-white/5 mb-6 overflow-hidden">
            <div className="flex">
              ...
              <div className="p-4 sm:p-6 flex flex-col justify-center">
                <div
                  className="font-display text-lg sm:text-xl uppercase tracking-tight hover:text-lime transition-colors cursor-pointer"
                >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div
              className="flex-1 flex items-center justify-center gap-2 bg-lime text-dark py-3 font-semibold uppercase text-sm tracking-wide hover:bg-limehover transition-colors cursor-pointer"
            >
