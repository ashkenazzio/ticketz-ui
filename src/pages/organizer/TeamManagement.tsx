      ...
      <div className="bg-surface border border-white/5 overflow-hidden mb-8">
        ...
        <div className="divide-y divide-white/5">
          {filteredMembers.map((member) => (
            <div
              key={member.id}
              className="relative px-6 py-4 hover:bg-dark/30 transition-colors"
            >
              ...
              {member.role !== 'owner' && (
                <div className="absolute right-4 top-4 md:hidden">
                  ...
                  >
                    ...
                    {member.role === 'admin' && (
                      <DropdownItem>Demote to Moderator</DropdownItem>
                    )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                ...
                {/* Desktop: Actions */}
                <div className="col-span-2 hidden md:flex justify-end relative">
                  {member.role !== 'owner' ? (
                    <Dropdown
                      trigger={
                        <button className="p-2 text-gray-400 hover:text-white transition-colors">
              ...
              {pendingInvites.map((invite) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                    ...
                    <div className="flex items-center gap-4 sm:gap-2 ml-14 sm:ml-0">
                      <button className="text-xs text-lime hover:text-limehover uppercase tracking-wide">
                        Resend
                      </button>
                      <button className="text-xs text-red-400 hover:text-red-300 uppercase tracking-wide">
                        Cancel
                      </button>
                    </div>
                  </div>
